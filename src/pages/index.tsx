      ...
      <main>
          ...
          <div className="container">
            ...
            >
              ...
              <p className="text-base text-body">
                Are you tired of using resume builders that sacrifice your
                privacy for convenience? Look no further than Trustky - a
                revolutionary resume-building platform that puts your data
                security first. With Trustky, you can confidently create your
                perfect resume while maintaining full control over who can
		...
		s-57.082-4.852-83.768-16.791c-0.477-0.323-2.265-1.932-2.36-8.238C157.58,307.036,159.677,266.771,172.086,248.342z
		 M285.438,433.861H150.569v-21.553h134.868V433.861L285.438,433.861z M336.882,391.455H150.569v-21.553h186.312V391.455z"
                    ...
                    <p className="text-base text-body">
                      fetch your credentials from platforms like GitHub,
                      LinkedIn, and Upwork only with your explicit consent. You
                      decide what information is shown publicly
                    </p>
                  </div>
                </div>
                ...
                <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                  ...
                  >
                    ...
                    <p className="text-base text-body">
                      Trustky employs state-of-the-art encryption methodslike
                      Lit protocol
                    </p>
                  </div>
                </div>
                ...
                <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                  ...
                  >
                    ...
                    <p className="text-base text-body">
                      Tailor your resume's visibility to your liking. With
                      Trustky, you have the power to choose which sections of
                      your resume are visible to the public and which ones
                ...
                <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                  ...
                  >
                    ...
                    <p className="text-base text-body">
                      We use technology like worldcoin or EAS to help you to
                ...
                <div className="w-full px-4 md:w-1/2 lg:w-1/3 relative">
                  ...
                  >
                    ...
                    <p className="text-base text-body">
                      Trustky allows other users to request access to specific
                      parts of your resume. You'll receive a notification and
                ...
                <div className="w-full px-4 lg:w-1/2">
                  ...
                  >
                    ...
                    <p className="mb-[30px] text-base leading-relaxed text-body">
                      Take charge of your resume-building experience with
                      Trustky. Say goodbye to compromising your privacy for the
                      sake of convenience. Embrace a new era of resume building
                      where trust and security go hand in hand.
                      <br /> Ready to build your resume with confidence? Sign up
                      for Trustky now and unlock the power of privacy in the
                      world of resume building. Your privacy matters, and at
                      Trustky, we've got your back every step of the way.
                    </p>
                  </div>
                </div>
              </div>
